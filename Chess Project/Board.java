...
public class Board {
    ...
    public void updateChecks() { 
        ...
        for (int r = 0; r < board.length; r ++) {
            for (int c = 0; c < board[r].length; c++) {
                ...
                // handleRookChecks(r, c);
                handleKnightCheck(r, c);
            }
        }
    }
    ...
    private void handleRookChecks(int r, int c) {
        int tempR = r;
        int tempC = c;
        if (board[r][c] instanceof Rook) {
            //Sets true until horizontal-right path is blocked by a piece or reaches end of board.
            while (r >= 0 && r <= 7 && c+1 >= 0 && c+1 <= 7 && board[r][c+1] == null){
                if (board[tempR][tempC].getColor().equals("white")) {
                    dangerW[r][c+1] = true;
                }
            ...
            if (r >= 0 && r <= 7 && c+1 >= 0 && c+1 <= 7 && board[r][c+1] != null) {
                if (board[tempR][tempC].getColor().equals("white")) {
                    dangerW[r][c+1] = true;
                }
            ...
            r = tempR;
            c = tempC;
            //Sets true until upward path is blocked by a piece or reaches end of board.
            while (r+1 >= 0 && r+1 <= 7 && c >= 0 && c <=7 && board[r+1][c] == null){
                if (board[tempR][tempC].getColor().equals("white")) {
                    dangerW[r+1][c] = true;
                }
            ...
            if (r+1 >= 0 && r+1 <= 7 && c >= 0 && c <=7 && board[r+1][c] != null) {
                if (board[tempR][tempC].getColor().equals("white")) {
                    dangerW[r+1][c] = true;
                }
            ...
            r = tempR;
            c = tempC;
            //Sets true until downward path is blocked by a piece or reaches end of board.
            while (r-1 >= 0 && r-1 <= 7 && c >= 0 && c <=7 && board[r-1][c] == null){
                if (board[tempR][tempC].getColor().equals("white")) {
                    dangerW[r-1][c] = true;
                }
    ...
    private void handleKnightCheck(int r, int c) {

        boolean inBounds  = r > 1 && r < 6 && c > 1 && c < 6;
        if (board[r][c] instanceof Knight && board[r][c].getColor().equals("white") && inBounds) {
            dangerW[r-2][c-1] = true;
            dangerW[r-2][c+1] = true;
            
            dangerW[r+2][c-1] = true;
            dangerW[r+2][c+1] = true;
            
            dangerW[r-1][c+2] = true;
            dangerW[r+1][c+2] = true;
        ...
        if (board[r][c] instanceof Knight && board[r][c].getColor().equals("black") && inBounds) {
            System.out.println("Is Black");
            dangerB[r-2][c-1] = true;
            dangerB[r-2][c+1] = true;
            
            dangerB[r+2][c-1] = true;
            dangerB[r+2][c+1] = true;
            
            dangerB[r-1][c+2] = true;
            dangerB[r+1][c+2] = true;
